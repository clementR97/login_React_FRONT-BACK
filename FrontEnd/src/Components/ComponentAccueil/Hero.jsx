                    ...
                    <Container sx={{display: 'flex',
                                    ...
                                    pb: { xs: 8, sm: 12 },
                                        ...
                                        <Stack spacing={2} useFlexGap sx={{alignItems:'center', width:{xs:'100%',sm:'70%'} }}>
                                            ...
                                            Our&nbsp;latest&nbsp;
                                                <Typography component="span" variant='h1' sx={(theme)=>({
                                                    fontSize: 'inherit',
                                                    color:'primary.main',
                                                    ...theme.applyStyles('dark',{
                                                        color:'primary.light',
                                                ...
                                                <Stack direction={{xs:'column',sm:'row'}} spacing={1} useFlexGap sx={{pt:2, width:{xs:'100%',sm:'350px'}}}>
                                                    ...
                                                    Email 
                                                            ...
                                                            <TextField id='email-hero' hiddenLabel size='small' variant='outlined' aria-label='Enter your email address' placeholder='Your email adress' fullWidth 
                                                            slotProps={{
                                                                htmlInput:{
                                                                    autoComplete:'off',
